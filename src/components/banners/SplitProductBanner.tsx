...
const SplitProductBanner = () => {
  ...
  return (
    <section ref={ref} className={`py-8 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
      <div className="grid grid-cols-1 md:grid-cols-2 rounded-xl overflow-hidden border border-border bg-card">
        <div className="aspect-[4/3] md:aspect-auto overflow-hidden group">
