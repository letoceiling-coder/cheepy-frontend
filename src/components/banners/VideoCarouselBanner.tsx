...
const Card = ({ card }: { card: (typeof cards)[0] }) => (
  <div className="min-w-[160px] sm:min-w-[180px] flex-shrink-0 rounded-xl overflow-hidden border border-border bg-card group cursor-pointer">
    <div className="aspect-[4/3] max-h-[160px] overflow-hidden relative">
