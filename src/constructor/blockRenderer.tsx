...
const componentMap: Record<string, React.LazyExoticComponent<React.ComponentType<any>>> = {
  ...
  RandomModelShowcase: lazy(() => import('@/components/sections/ModelShowcase/RandomModelShowcase')),
  TrendingFashionShowcase: lazy(() => import('@/components/sections/ModelShowcase/TrendingFashionShowcase')),
  NewCollectionModels: lazy(() => import('@/components/sections/ModelShowcase/NewCollectionModels')),
  ...
  ProductPageBreadcrumbs: lazy(() => import('@/components/page-blocks/product/ProductPageBreadcrumbs')),
  ProductDetailHero: lazy(() => import('@/components/page-blocks/product/ProductDetailHero')),
  ProductDetailTabsSection: lazy(() => import('@/components/page-blocks/product/ProductDetailTabsSection')),
  ProductSellerCardSection: lazy(() => import('@/components/page-blocks/product/ProductSellerCardSection')),
  ProductRecentlyViewedSection: lazy(() => import('@/components/page-blocks/product/ProductRecentlyViewedSection')),
  ProductBuyTogetherSection: lazy(() => import('@/components/page-blocks/product/ProductBuyTogetherSection')),
  ProductSimilarProductsSection: lazy(() => import('@/components/page-blocks/product/ProductSimilarProductsSection')),
  CategoryPageBreadcrumbs: lazy(() => import('@/components/page-blocks/category/CategoryPageBreadcrumbs')),
  CategoryHeroBanner: lazy(() => import('@/components/page-blocks/category/CategoryHeroBanner')),
  CategoryListingContent: lazy(() => import('@/components/page-blocks/category/CategoryListingContent')),
  CartPageContent: lazy(() => import('@/components/page-blocks/cart/CartPageContent')),
  FavoritesPageContent: lazy(() => import('@/components/page-blocks/favorites/FavoritesPageContent')),
  AuthPageContent: lazy(() => import('@/components/page-blocks/auth/AuthPageContent')),
  BrandsListBreadcrumbs: lazy(() => import('@/components/page-blocks/brands/BrandsListBreadcrumbs')),
  BrandsListHero: lazy(() => import('@/components/page-blocks/brands/BrandsListHero')),
  BrandsListPopularSection: lazy(() => import('@/components/page-blocks/brands/BrandsListPopularSection')),
  BrandsListAllSection: lazy(() => import('@/components/page-blocks/brands/BrandsListAllSection')),
  BrandsListInfoSection: lazy(() => import('@/components/page-blocks/brands/BrandsListInfoSection')),
