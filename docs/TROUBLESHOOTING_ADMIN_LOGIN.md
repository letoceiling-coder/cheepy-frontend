...
В репозитории есть скрипт `scripts/fix-admin-user.php` — он создаёт/обновляет запись в таблице `admin_users` для email `dsc-23@yandex.ru` и задаёт пароль **`123123123`** (сразу смените после входа).
